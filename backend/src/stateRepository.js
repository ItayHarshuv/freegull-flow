...
export async function writeState(clubId, state) {
...
export async function readState(clubId) {
  const [clubRowRes, usersRes, certsRes, shiftsRes, bonusesRes, activeShiftsRes] = await Promise.all([
    ...
    withTx((client) => client.query("SELECT * FROM users WHERE club_id = $1", [clubId])),
    withTx((client) =>
      client.query(
        `
    ...
    withTx((client) => client.query("SELECT * FROM shifts WHERE club_id = $1", [clubId])),
    withTx((client) =>
      client.query(
        `
    ...
    withTx((client) => client.query("SELECT * FROM active_shifts WHERE club_id = $1", [clubId])),
  ]);
  ...
  const [
    ...
    withTx((client) => client.query("SELECT * FROM confirmed_shifts WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM lessons WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM rentals WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM tasks WHERE club_id = $1", [clubId])),
    withTx((client) =>
      client.query(
        `
    ...
    withTx((client) => client.query("SELECT * FROM leads WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM availability WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM sea_events WHERE club_id = $1", [clubId])),
    withTx((client) =>
      client.query(
        `
    ...
    withTx((client) => client.query("SELECT * FROM whatsapp_templates WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM knowledge_files WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM club_rental_items WHERE club_id = $1", [clubId])),
    withTx((client) => client.query("SELECT * FROM club_rental_statuses WHERE club_id = $1", [clubId])),
  ]);
